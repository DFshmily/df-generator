...
import com.df.maker.meta.enums.FileGenerateTypeEnum;
import com.df.maker.meta.enums.FileTypeEnum;
import com.df.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "Dfshmily");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.df");
